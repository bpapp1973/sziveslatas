...
(function() {
			...
			on: function(b, d, g, k, l) {
				...
				if (0 > e.getListenerIndex(d)) {
					...
					for (var r = e.length - 1; 0 <= r; r--)
						if (e[r].priority <= l) return e.splice(r + 1, 0, m), {
							removeListener: u
						};
					e.unshift(m)
				}
	...
	(function() {
		...
		function b(a, c, f, g) {
			...
			if ((k = CKEDITOR.filter.instances[g.element.data("cke-filter")]) && !k.check(c)) return b(a,
				c, f, g.remaining);c = new CKEDITOR.dom.range(g.element);c.selectNodeContents(g.element);c = c.createIterator();c.enlargeBr = a.enlargeBr;c.enforceRealBlocks = a.enforceRealBlocks;c.activeFilter = c.filter = k;a._.nestedEditable = {
				element: g.element,
				container: f,
				...
				if ("br" == b) a.previous && !v(a.previous) && (b = t(), b.insertBefore(a)), a.next && !v(a.next) && (b = t(), b.insertAfter(a)), a.replaceWithChildren();
					...
					b: {
						...
						for (var p = 0, f = d.length, n; p < f; ++p)
							if (n = d[p], n.type == CKEDITOR.NODE_ELEMENT && !h[n.name]) {
								h = !1;
								break b
							}
						h = !0
		...
		function A(a) {
			...
			CKEDITOR.plugins.load(c.split(","), function(c) {
				...
				for (var e in c) {
					...
					if (l && (m = l.match(p)))
						for (; l = m.pop();) CKEDITOR.error("editor-plugin-required", {
							plugin: l.replace(",", ""),
							requiredBy: e
						});
	...
	*/
				...
				CKEDITOR.dialog.add("youtube", function() {
					...
					return {
						...
						onOk: function() {
							var a = "",
								e = "";
							if (this.getContentElement("youtubePlugin", "txtEmbed").isEnabled()) a = this.getValueOf("youtubePlugin", "txtEmbed");
							else {
								var b = "//",
									d = [],
									f, h = this.getValueOf("youtubePlugin", "txtWidth"),
	...
	CKEDITOR.config.plugins = 'dialogui,dialog,a11yhelp,basicstyles,blockquote,clipboard,panel,floatpanel,menu,contextmenu,resize,button,toolbar,elementspath,enterkey,entities,popup,filebrowser,floatingspace,listblock,richcombo,format,horizontalrule,htmlwriter,wysiwygarea,indent,indentlist,list,magicline,maximize,pastetext,pastefromword,removeformat,showborders,sourcearea,specialchar,stylescombo,tab,table,tabletools,undo,wsc,divarea,youtube';
